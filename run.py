...
os.environ["MONGO_CONNECTION_STR"] = "mongodb+srv://ashwin:pswd123ash@retail-demo.2wqno.mongodb.net/?retryWrites=true&w=majority"
...
def get_vector_store():
    col = db["chatapp"]
    vs = MongoDBAtlasVectorSearch(collection=col,embedding=get_embeddings_transformer(),index_name="default",embedding_key="vec", text_key="line")
    return vs
...
def main():
    ...
    st.markdown("""<img src="https://webimages.mongodb.com/_com_assets/cms/kuyjf3vea2hg34taa-horizontal_default_slate_blue.svg?auto=format%252Ccompress" class=" css-1lo3ubz" alt="MongoDB logo" style="height:300px;width:500px;align:center"> """, unsafe_allow_html=True)
